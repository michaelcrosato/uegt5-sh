...
Until the first playable build ships, the version stays at `0.0.x` and `main`
carries everything under **[Unreleased]**.

## [Unreleased]

### Added

- Repository scaffolding: Git + Git LFS configuration for an Unreal Engine 5 project.
